...
const Header = ({ sidebarToggle }: HeaderProps) => {
  return (
    <div className="fixed select-none w-full shadow-md md:shadow-none flex justify-center bg-white px-4 py-3 text-gray-600 dark:bg-primary dark:text-gray-300">
